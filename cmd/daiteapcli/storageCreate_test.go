...
func TestRunStorageCreateCmd_Success(t *testing.T) {
	...
	cmd.Flags().String("provider", "aws", "aws")

	// Call the RunStorageCreateCmd function
	daiteapcmd.RunStorageCreateCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledRequestBody != "{\"provider\": \"aws\", \"credential\": \"\", \"project\": \"\", \"name\": \"\", \"bucket_location\": \"\"}" {
		t.Errorf("expected SendDaiteapRequest to be called with '{\"provider\": \"aws\", \"credential\": \"\", \"project\": \"\", \"name\": \"\", \"bucket_location\": \"\"}', but got %v", sendDaiteapRequestcalledRequestBody)
	}
...
func TestRunStorageCreateCmd_RequestSenderError(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
	...
	// Call the RunStorageCreateCmd function with an empty slice of strings
	daiteapcmd.RunStorageCreateCmd(cmd, []string{})
...
// Test the RunStorageCreateCmd function with the dry-run flag set
func TestRunStorageCreateCmd_DryRun(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunStorageCreateCmd function with the verbose flag set
func TestRunStorageCreateCmd_Verbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunStorageCreateCmd function with both the dry-run and verbose flags set
func TestRunStorageCreateCmd_DryRunVerbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
func TestRunStorageCreateCmd_Success_changed_fields(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
