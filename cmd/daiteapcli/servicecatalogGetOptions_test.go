...
func TestRunServicecatalogGetOptionsCmd_Success(t *testing.T) {
	...
	cmd.Flags().String("service", "123", "123")

	// Call the RunServicecatalogGetOptionsCmd function
	daiteapcmd.RunServicecatalogGetOptionsCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "/services/123/options" {
		t.Errorf("expected SendDaiteapRequest to be called with '/services/123/options', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunServicecatalogGetOptionsCmd_Failure(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
...
func TestRunServicecatalogGetOptionsCmd_Success_Dryrun(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
