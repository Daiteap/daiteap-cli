...
func TestRunWorkspaceListCmd_Success(t *testing.T) {
	...
	var expectedTableNewColumnHeaders = []string{"Name", "Owner", "Email", "Phone", "Created at", "Updated at", "Active"}
	...
	// Call the RunWorkspaceListCmd function
	daiteapcmd.RunWorkspaceListCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "/user/active-tenants" {
		t.Errorf("expected SendDaiteapRequest to be called with '/user/active-tenants', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunWorkspaceListCmd_OutputFormat_Wide(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
...
func TestRunWorkspaceListCmd_OutputFormat_Json(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
