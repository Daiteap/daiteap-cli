...
func TestRunWorkspaceGetCmd_Success(t *testing.T) {
	...
	// Call the RunWorkspaceGetCmd function
	daiteapcmd.RunWorkspaceGetCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "" {
		t.Errorf("expected SendDaiteapRequest to be called with '', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunWorkspaceGetCmd_Failure(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
...
func TestRunWorkspaceGetCmd_Success_Dryrun(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
