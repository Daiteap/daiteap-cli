...
func TestRunStorageDeleteCmd_Success(t *testing.T) {
	...
	// Call the RunStorageDeleteCmd function
	daiteapcmd.RunStorageDeleteCmd(cmd, []string{})
...
func TestRunStorageDeleteCmd_RequestSenderError(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
	...
	// Call the RunStorageDeleteCmd function with an empty slice of strings
	daiteapcmd.RunStorageDeleteCmd(cmd, []string{})
...
// Test the RunStorageDeleteCmd function with the dry-run flag set
func TestRunStorageDeleteCmd_DryRun(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunStorageDeleteCmd function with the verbose flag setwwwwwwwwww
func TestRunStorageDeleteCmd_Verbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunStorageDeleteCmd function with both the dry-run and verbose flags set
func TestRunStorageDeleteCmd_DryRunVerbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
