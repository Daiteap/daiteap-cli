...
func TestRunQuotaListCmd_Success(t *testing.T) {
	...
	// Call the RunQuotaListCmd function
	daiteapcmd.RunQuotaListCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "/quotas" {
		t.Errorf("expected SendDaiteapRequest to be called with '/quotas', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunQuotaListCmd_RequestSenderError(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
	...
	// Call the RunQuotaListCmd function with an empty slice of strings
	daiteapcmd.RunQuotaListCmd(cmd, []string{})
...
// Test the RunQuotaListCmd function with the dry-run flag set
func TestRunQuotaListCmd_DryRun(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunQuotaListCmd function with the verbose flag set
func TestRunQuotaListCmd_Verbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunQuotaListCmd function with both the dry-run and verbose flags set
func TestRunQuotaListCmd_DryRunVerbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
