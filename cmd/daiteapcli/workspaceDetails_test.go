...
func TestRunWorkspaceDetailsCmd_Success(t *testing.T) {
	...
	// Call the RunWorkspaceDetailsCmd function
	daiteapcmd.RunWorkspaceDetailsCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "/tenants/" {
		t.Errorf("expected SendDaiteapRequest to be called with '/tenants/', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunWorkspaceDetailsCmd_Failure(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
...
func TestRunWorkspaceDetailsCmd_Success_Dryrun(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
