...
func TestRunUserDeleteCmd_Success(t *testing.T) {
	...
	// Call the RunUserDeleteCmd function
	daiteapcmd.RunUserDeleteCmd(cmd, []string{})
...
func TestRunUserDeleteCmd_RequestSenderError(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
	...
	// Call the RunUserDeleteCmd function with an empty slice of strings
	daiteapcmd.RunUserDeleteCmd(cmd, []string{})
...
// Test the RunUserDeleteCmd function with the dry-run flag set
func TestRunUserDeleteCmd_DryRun(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunUserDeleteCmd function with the verbose flag set
func TestRunUserDeleteCmd_Verbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunUserDeleteCmd function with both the dry-run and verbose flags set
func TestRunUserDeleteCmd_DryRunVerbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
