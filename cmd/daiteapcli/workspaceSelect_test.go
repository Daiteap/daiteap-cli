...
func TestRunWorkspaceSelect_Success(t *testing.T) {
	...
	// Call the RunWorkspaceSelect function
	daiteapcmd.RunWorkspaceSelect(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "/user/select-tenant" {
		t.Errorf("expected SendDaiteapRequest to be called with '/user/select-tenant', but got %v", sendDaiteapRequestcalledEndpoint)
	}

	if sendDaiteapRequestcalledRequestBody != "{\"selectedTenant\": \"\"}" {
		t.Errorf("expected SendDaiteapRequest to be called with '{\"selectedTenant\": \"\"}', but got %v", sendDaiteapRequestcalledRequestBody)
	}
...
func TestRunWorkspaceSelect_RequestSenderError(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
	...
	// Call the RunWorkspaceSelect function with an empty slice of strings
	daiteapcmd.RunWorkspaceSelect(cmd, []string{})
...
// Test the RunWorkspaceSelect function with the dry-run flag set
func TestRunWorkspaceSelect_DryRun(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunWorkspaceSelect function with the verbose flag set
func TestRunWorkspaceSelect_Verbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunWorkspaceSelect function with both the dry-run and verbose flags set
func TestRunWorkspaceSelect_DryRunVerbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
