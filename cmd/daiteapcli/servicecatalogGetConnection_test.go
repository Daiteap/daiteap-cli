...
func TestRunServicecatalogGetConnectionCmd_Success(t *testing.T) {
	...
	// Call the RunServicecatalogGetConnectionCmd function
	daiteapcmd.RunServicecatalogGetConnectionCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledEndpoint != "/clusters/cluster-1/services/service-123/namespace-1/connection-info" {
		t.Errorf("expected SendDaiteapRequest to be called with '/clusters/cluster-1/services/service-123/namespace-1/connection-info', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunServicecatalogGetConnectionCmd_Failure(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
...
func TestRunServicecatalogGetConnectionCmd_Success_Dryrun(t *testing.T) {
	// Mock the DaiteapcliSendDaiteapRequest function
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
