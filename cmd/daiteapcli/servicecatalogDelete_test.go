...
func TestRunServicecatalogDeleteCmd_Success(t *testing.T) {
	...
	cmd.Flags().String("name", "service-123", "service-123")
	cmd.Flags().String("cluster", "cluster-1", "cluster-1")
	cmd.Flags().String("namespace", "namespace-1", "namespace-1")

	// Call the RunServicecatalogDeleteCmd function
	daiteapcmd.RunServicecatalogDeleteCmd(cmd, []string{})
	...
	if sendDaiteapRequestcalledMethod != "DELETE" {
		t.Errorf("expected SendDaiteapRequest to be called with 'DELETE', but got %v", sendDaiteapRequestcalledMethod)
	}

	if sendDaiteapRequestcalledEndpoint != "/clusters/cluster-1/services/service-123/namespace-1" {
		t.Errorf("expected SendDaiteapRequest to be called with '/clusters/cluster-1/services/service-123/namespace-1', but got %v", sendDaiteapRequestcalledEndpoint)
	}
...
func TestRunServicecatalogDeleteCmd_RequestSenderError(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
	...
	// Call the RunServicecatalogDeleteCmd function with an empty slice of strings
	daiteapcmd.RunServicecatalogDeleteCmd(cmd, []string{})
...
// Test the RunServicecatalogDeleteCmd function with the dry-run flag set
func TestRunServicecatalogDeleteCmd_DryRun(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunServicecatalogDeleteCmd function with the verbose flag set
func TestRunServicecatalogDeleteCmd_Verbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
...
// Test the RunServicecatalogDeleteCmd function with both the dry-run and verbose flags set
func TestRunServicecatalogDeleteCmd_DryRunVerbose(t *testing.T) {
	sendDaiteapRequestCalledTimes := 0
	sendDaiteapRequestcalledMethod := ""
	sendDaiteapRequestcalledEndpoint := ""
	sendDaiteapRequestcalledRequestBody := ""
